      ...
      >
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: "center", padding: "80px 24px" }}>
            ...
            <button className="btn-gold" onClick={() => onNav("pick-type")}>
              + Add First Memory
            </button>
          </div>
        ) : (
...
function DetailView({
  ...
  return (
    ...
    >
      ...
      >
        <button className="back-btn" onClick={() => onNav(backView)}>
          <ChevL /> Back to memories
        </button>
        <Logo compact />
      </header>
    ...
    <>
      ...
      {view === "guest-pick-type" && (
        <div style={{ minHeight: "100vh", background: "var(--black)" }}>
          ...
          >
            <button className="back-btn" onClick={() => setView("guest-space")}>
              <ChevL /> Back
            </button>
            <Logo compact />
          </header>
      ...
      {view === "guest-add" && guestSpace && (
        <div style={{ minHeight: "100vh", background: "var(--black)" }}>
          ...
          >
            <button
              className="back-btn"
              onClick={() => setView("guest-pick-type")}
            >
              <ChevL /> Back
            </button>
            <Logo compact />
