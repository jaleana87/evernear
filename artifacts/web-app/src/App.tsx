    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#f5f5dc] font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 border-b border-[#222] backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="ml-6 px-6 py-2.5 bg-[#C9A24A] text-[#0a0a0a] rounded-full text-sm tracking-[2px] hover:bg-[#D6B76A] transition">
              GET STARTED
            </button>
          </div>
        </div>
      ...
      <section id="hero" className="pt-20 min-h-[100dvh] flex items-center justify-center px-8 relative overflow-hidden bg-gradient-to-b from-[#0a0a0a] via-[#111] to-[#0a0a0a]">
        ...
        <div className="max-w-4xl text-center relative z-10">
          ...
          <p className="max-w-xl mx-auto text-xl text-[#aaa] mb-10">Photos, videos, notes, voice messages, memes, and links — saved privately with the people who matter.</p>
          <div className="flex gap-4 justify-center">
            <button className="px-10 py-4 rounded-full bg-[#C9A24A] text-[#0a0a0a] font-medium tracking-widest text-sm hover:bg-[#D6B76A] transition">CREATE YOUR EVERNEAR</button>
      ...
      <section id="features" className="max-w-6xl mx-auto px-8 py-24 grid md:grid-cols-3 gap-8">
        {[
          ...
          <div key={i} className="bg-[#111] border border-[#222] p-10 rounded-3xl hover:border-[#C9A24A]/30 transition group">
            <div className="text-[#C9A24A] text-xs tracking-[3px] mb-4">0{i + 1}</div>
      ...
      <section id="mockups" className="bg-[#111] py-20 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#C9A24A] text-xs tracking-[4px] mb-3">EXPERIENCE THE PRODUCT</div>
          ...
          <div className="flex justify-center gap-2 mb-12 flex-wrap">
            {['login', 'dashboard', 'share', 'memory'].map((view) => (
              <button
                ...
                className={`px-8 py-3 text-sm tracking-widest rounded-full border transition ${activeMockup === view ? 'bg-[#C9A24A] text-black border-[#C9A24A]' : 'border-[#333] hover:bg-[#222]'}`}
              >
                {view.toUpperCase()}
              </button>
            ))}
              ...
              <MockupFrame title="LOGIN • EVERNEAR">
                <div className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <button className="w-full py-4 rounded-2xl bg-[#C9A24A] text-black font-medium tracking-widest mt-4">SIGN IN</button>
                  </div>
                  <div className="text-center text-xs text-[#666] mt-8 tracking-widest">FORGOTTEN PASSWORD?</div>
                </div>
              </MockupFrame>
            )}
              ...
              <MockupFrame title="DASHBOARD">
                <div className="p-6">
                  <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="w-9 h-9 rounded-full bg-[#C9A24A]" />
                  </div>
            ...
            {activeMockup === 'share' && (
              <MockupFrame title="SHARE • UPLOAD">
                <div className="p-8 space-y-6">
                  <div className="border border-dashed border-[#C9A24A]/40 rounded-3xl h-48 flex items-center justify-center text-[#C9A24A]">Drop memory here</div>
                  <div className="bg-[#1a1a1a] p-5 rounded-2xl flex justify-between items-center">
                    <div>family-space-2024</div>
                    <button className="text-xs px-4 py-1.5 border border-[#C9A24A] rounded-full">SHARE</button>
                  </div>
                </div>
              </MockupFrame>
            )}
      ...
      <footer id="footer" className="border-t border-[#222] py-16 px-8 text-center text-xs tracking-[3px] text-[#555]">
        © My EverNear — Moments shared privately.
      </footer>
    </div>
  );
}