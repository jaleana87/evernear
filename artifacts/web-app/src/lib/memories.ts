...
function resolveImageUrl(path: string | null, bucket: string): string | undefined {
...
export async function toggleLike(memoryId: string, currentLiked: boolean): Promise<void> {
